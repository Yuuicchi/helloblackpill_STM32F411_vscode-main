...
static void MX_GPIO_Init(void)
{
    ...
    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOA, trig_Pin | led1_Pin | led2_Pin | led3_Pin, GPIO_PIN_RESET);
    ...
    /*Configure GPIO pins : trig_Pin led1_Pin led2_Pin led3_Pin */
    GPIO_InitStruct.Pin = trig_Pin | led1_Pin | led2_Pin | led3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
